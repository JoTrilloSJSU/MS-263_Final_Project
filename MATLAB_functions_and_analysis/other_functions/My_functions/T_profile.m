function [profile_temperature] = T_profile(fname, P_start, P_end, varargin)
% T_PROFILE Extracts and returns temperature data for a specific profile
...
if exist('P_slow', 'var') && exist('W_slow', 'var') && exist('JAC_T', 'var')
    ...
    % Extract temperature data for the specific profile
